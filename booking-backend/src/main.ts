...
// Prisma 6+ returns BigInt from groupBy _count, aggregate, and raw COUNT(*) queries.
// JSON.stringify cannot serialize BigInt → crashes admin dashboard. Add global serializer.
