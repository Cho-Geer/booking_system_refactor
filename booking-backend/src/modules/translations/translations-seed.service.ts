...
const DEFAULT_TRANSLATIONS: TranslationSeedEntry[] = [
  ...
  { domain: 'global', key: 'apply', locale: 'en', value: 'Apply', isCustom: false, tenantId: null },
  { domain: 'global', key: 'verified', locale: 'en', value: 'Verified', isCustom: false, tenantId: null },
  ...
  { domain: 'admin', key: 'dashboard.welcome', locale: 'en', value: 'Welcome back', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'dashboard.viewBookings', locale: 'en', value: 'View Bookings', isCustom: false, tenantId: null },
  // -- admin.stats
  { domain: 'admin', key: 'stats.todayBookings', locale: 'en', value: "Today's Bookings", isCustom: false, tenantId: null },
  { domain: 'admin', key: 'stats.pendingBookings', locale: 'en', value: 'Pending Confirmation', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'stats.activeUsers', locale: 'en', value: 'Total Customers', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'stats.totalRevenue', locale: 'en', value: 'Total Revenue', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'stats.target', locale: 'en', value: 'Target:', isCustom: false, tenantId: null },
  // -- admin.charts
  { domain: 'admin', key: 'charts.bookingTrends', locale: 'en', value: 'Booking Trends', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'charts.weekly', locale: 'en', value: 'Weekly', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'charts.monthly', locale: 'en', value: 'Monthly', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'charts.yearly', locale: 'en', value: 'Yearly', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'charts.bookings', locale: 'en', value: 'Bookings', isCustom: false, tenantId: null },
  // -- admin.distribution
  { domain: 'admin', key: 'distribution.title', locale: 'en', value: 'Booking Distribution', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.services', locale: 'en', value: 'Services', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.time', locale: 'en', value: 'Time', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.selectDate', locale: 'en', value: 'Select Date Range', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.from', locale: 'en', value: 'From', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.to', locale: 'en', value: 'To', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'distribution.apply', locale: 'en', value: 'Apply', isCustom: false, tenantId: null },
  // -- admin.system
  { domain: 'admin', key: 'system.title', locale: 'en', value: 'System Status', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'system.cpu', locale: 'en', value: 'CPU', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'system.memory', locale: 'en', value: 'Memory', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'system.disk', locale: 'en', value: 'Disk', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'system.online', locale: 'en', value: 'Online', isCustom: false, tenantId: null },
  // -- admin.recent
  { domain: 'admin', key: 'recent.bookings', locale: 'en', value: 'Recent Bookings', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'recent.users', locale: 'en', value: 'Recent Users', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'recent.services', locale: 'en', value: 'Recent Services', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'recent.viewAll', locale: 'en', value: 'View All', isCustom: false, tenantId: null },
  // -- admin.table
  { domain: 'admin', key: 'table.customer', locale: 'en', value: 'Customer', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.service', locale: 'en', value: 'Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.date', locale: 'en', value: 'Date', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.status', locale: 'en', value: 'Status', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.actions', locale: 'en', value: 'Actions', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.view', locale: 'en', value: 'View', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.name', locale: 'en', value: 'Name', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.email', locale: 'en', value: 'Email', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.role', locale: 'en', value: 'Role', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.created', locale: 'en', value: 'Created', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.duration', locale: 'en', value: 'Duration', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.price', locale: 'en', value: 'Price', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'table.active', locale: 'en', value: 'Active', isCustom: false, tenantId: null },
  // -- admin.users
  { domain: 'admin', key: 'users.title', locale: 'en', value: 'User Management', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.newUser', locale: 'en', value: 'New User', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.totalUsers', locale: 'en', value: 'Total Users', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.activeUsers', locale: 'en', value: 'Active Users', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.newThisWeek', locale: 'en', value: 'New This Week', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.allRoles', locale: 'en', value: 'All Roles', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.allStatuses', locale: 'en', value: 'All Statuses', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.searchPlaceholder', locale: 'en', value: 'Search users...', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.phone', locale: 'en', value: 'Phone', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.noUsers', locale: 'en', value: 'No users found.', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.viewUser', locale: 'en', value: 'View User', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'users.editUser', locale: 'en', value: 'Edit User', isCustom: false, tenantId: null },
  // -- admin.services
  { domain: 'admin', key: 'services.title', locale: 'en', value: 'Service Management', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.newService', locale: 'en', value: 'New Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.totalServices', locale: 'en', value: 'Total Services', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.activeServices', locale: 'en', value: 'Active Services', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.avgPrice', locale: 'en', value: 'Avg Price', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.allCategories', locale: 'en', value: 'All Categories', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.searchPlaceholder', locale: 'en', value: 'Search services...', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.name', locale: 'en', value: 'Name *', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.description', locale: 'en', value: 'Description', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.duration', locale: 'en', value: 'Duration (min) *', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.price', locale: 'en', value: 'Price ($) *', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.imageUrl', locale: 'en', value: 'Image URL', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.taxRate', locale: 'en', value: 'Tax Rate', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.noServices', locale: 'en', value: 'No services found.', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.viewService', locale: 'en', value: 'View Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.editService', locale: 'en', value: 'Edit Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'services.newServiceLabel', locale: 'en', value: 'New Service', isCustom: false, tenantId: null },
  // -- admin.appointments
  { domain: 'admin', key: 'appointments.title', locale: 'en', value: 'Appointment Management', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.newAppointment', locale: 'en', value: 'New Appointment', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.today', locale: 'en', value: 'Today', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.pending', locale: 'en', value: 'Pending', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.confirmed', locale: 'en', value: 'Confirmed', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.cancelled', locale: 'en', value: 'Cancelled', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.searchPlaceholder', locale: 'en', value: 'Search appointments...', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.updateStatus', locale: 'en', value: 'Update Appointment Status', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.noAppointments', locale: 'en', value: 'No appointments found.', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.customer', locale: 'en', value: 'Customer', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.service', locale: 'en', value: 'Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.appointmentDate', locale: 'en', value: 'Appointment Date', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.selectDate', locale: 'en', value: 'Select date...', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.timeSlot', locale: 'en', value: 'Time Slot *', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.selectTimeSlot', locale: 'en', value: 'Select time slot...', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.notes', locale: 'en', value: 'Notes', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'appointments.overtimeMinutes', locale: 'en', value: 'Overtime Minutes', isCustom: false, tenantId: null },
  // -- admin.welcome
  { domain: 'admin', key: 'welcome.title', locale: 'en', value: 'Welcome back', isCustom: false, tenantId: null },
  // -- admin.notifications
  { domain: 'admin', key: 'notifications.title', locale: 'en', value: 'Notifications', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'notifications.empty', locale: 'en', value: 'No notifications', isCustom: false, tenantId: null },
  // -- admin.quickBooking
  { domain: 'admin', key: 'quickBooking.title', locale: 'en', value: 'Quick Booking', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'quickBooking.customer', locale: 'en', value: 'Customer', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'quickBooking.selectCustomer', locale: 'en', value: 'Select a customer', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'quickBooking.service', locale: 'en', value: 'Service', isCustom: false, tenantId: null },
  { domain: 'admin', key: 'quickBooking.selectService', locale: 'en', value: 'Select a service', isCustom: false, tenantId: null },
