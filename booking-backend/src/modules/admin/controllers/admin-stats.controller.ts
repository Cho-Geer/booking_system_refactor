...
export class AdminStatsController {
  ...
  async getServiceDistribution(
    ...
    return this.adminStatsService.getServiceDistribution(timeRange, startDate, endDate);
  }
  ...
  @RateLimit({ tier: 'api', key: 'ip', limit: 30 })
  @ApiOperation({
    summary: 'Get hourly time distribution with formatted hour strings (DASH-004)',
  })
  @ApiQuery({
    name: 'timeRange',
    required: false,
  ...
  async getTimeDistribution(
    ...
    return this.adminStatsService.getTimeDistribution(timeRange, startDate, endDate);
  }
