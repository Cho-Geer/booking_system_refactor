...
describe('AdminStore', () => {
  ...
  it('should update user in list after successful update', () => {
    const user1: AdminUser = { id: '1', name: 'Alice', email: 'al***@test.com', role: 'CUSTOMER', status: 'ACTIVE', createdAt: '2026-01-01T00:00:00Z' };
    const user2: AdminUser = { id: '2', name: 'Bob', email: 'bo***@test.com', role: 'ADMIN', status: 'ACTIVE', createdAt: '2026-01-01T00:00:00Z' };
  ...
  it('should update service in list', () => {
    const svc: AdminServiceItem = { id: '1', name: 'Haircut', description: 'Cut', duration: 30, price: 25, active: true, createdAt: '2026-01-01T00:00:00Z' };
  ...
  it('should remove multiple appointments from list after batch cancel', () => {
    ...
    const appt2: AdminAppointment = {
      ...
      serviceId: 'svc1', serviceName: 'Haircut', timeSlotId: 'ts2',
  ...
  describe('[RED] loadStats()', () => {
    ...
    it('[RED] should fail: should handle API error', async () => {
      adminServiceMock.getStats.mockReturnValue(
        throwError(() => new Error('Stats fetch failed'))
      );
  ...
  describe('[RED] loadUsers()', () => {
    ...
    it('[RED] should fail: should call adminService.getUsers with query', async () => {
      const mockResponse: PaginatedResponse<AdminUser> = {
        items: [{ id: '1', name: 'Alice', email: 'al***@test.com', role: 'CUSTOMER', status: 'ACTIVE', createdAt: '2026-01-01T00:00:00Z' }],
  ...
  describe('[RED] createUser()', () => {
    const createDto: CreateAdminUserRequest = {
      name: 'New User', email: 'new@test.com', role: 'CUSTOMER', password: 'pass123',
    };
    ...
    it('[RED] should fail: should call adminService.createUser and add to list', async () => {
      const createdUser: AdminUser = { id: 'new-1', name: 'New User', email: 'new@test.com', role: 'CUSTOMER', status: 'ACTIVE', createdAt: '2026-05-01T00:00:00Z' };
  ...
  describe('[RED] updateUser()', () => {
    ...
    it('[RED] should fail: should call adminService.updateUser and update in list', async () => {
      const existing: AdminUser = { id: '1', name: 'Alice', email: 'al***@test.com', role: 'CUSTOMER', status: 'ACTIVE', createdAt: '2026-01-01T00:00:00Z' };
      adminServiceMock.getUsers.mockReturnValue(of({ items: [existing], total: 1, page: 1, limit: 20 }));
      await store.loadUsers({});

      const updates: UpdateAdminUserRequest = { name: 'Alice Updated', role: 'ADMIN' };
      const updatedUser: AdminUser = { ...existing, ...updates, name: 'Alice Updated', role: 'ADMIN' };
  ...
  describe('[RED] loadAdminServices()', () => {
    ...
    it('[RED] should fail: should call adminService.getAdminServices with query', async () => {
      const mockResponse: PaginatedResponse<AdminServiceItem> = {
        items: [{ id: '1', name: 'Haircut', description: 'Cut', duration: 30, price: 25, active: true, createdAt: '2026-01-01T00:00:00Z' }],
        total: 1, page: 1, limit: 20,
      };
  ...
  describe('[RED] createAdminService()', () => {
    ...
    it('[RED] should fail: should call adminService.createAdminService and add to list', async () => {
      const created: AdminServiceItem = { id: 'svc-new', name: 'New Service', description: '', duration: 45, price: 50, active: true, createdAt: '2026-05-01T00:00:00Z' };
  ...
  describe('[RED] updateAdminService()', () => {
    ...
    it('[RED] should fail: should call adminService.updateAdminService and update in list', async () => {
      const existing: AdminServiceItem = { id: '1', name: 'Haircut', description: 'Cut', duration: 30, price: 25, active: true, createdAt: '2026-01-01T00:00:00Z' };
      adminServiceMock.getAdminServices.mockReturnValue(of({ items: [existing], total: 1, page: 1, limit: 20 }));
  ...
  describe('[RED] updateAdminAppointmentStatus()', () => {
    ...
    it('[RED] should fail: should call adminService.updateAppointmentStatus and update in list', async () => {
      ...
      adminServiceMock.getAdminAppointments.mockReturnValue(of({ items: [appt], total: 1, page: 1, limit: 20 }));
      await store.loadAdminAppointments({});

      const statusDto: UpdateAppointmentStatusRequest = { status: 'CONFIRMED', reason: 'Available' };
      adminServiceMock.updateAppointmentStatus.mockReturnValue(of({ id: '1', status: 'CONFIRMED', updatedAt: '2026-05-01T00:00:00Z' }));
  ...
  describe('[RED] batchCancelAppointments()', () => {
    ...
    it('[RED] should fail: should call adminService.batchCancelAppointments and remove from list', async () => {
      ...
      adminServiceMock.getAdminAppointments.mockReturnValue(of({ items: [appt1, appt2], total: 2, page: 1, limit: 20 }));
      await store.loadAdminAppointments({});

      const batchDto: BatchCancelRequest = { ids: ['1', '2'], reason: 'Overbooking' };
      adminServiceMock.batchCancelAppointments.mockReturnValue(of({ successCount: 2, failedCount: 0, failedIds: [] }));
